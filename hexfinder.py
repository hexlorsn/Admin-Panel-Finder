...
{color.red}  /$$   /$$ /$$$$$$$$ /$$   /$$       /$$$$$$$$ /$$$$$$ /$$   /$$ /$$$$$$$  /$$$$$$$$ /$$$$$$$ 
{color.red} | $$  | $$| $$_____/| $$  / $$      | $$_____/|_  $$_/| $$$ | $$| $$__  $$| $$_____/| $$__  $$
{color.red} | $$  | $$| $$      |  $$/ $$/      | $$        | $$  | $$$$| $$| $$  \ $$| $$      | $$  \ $$
{color.red} | $$$$$$$$| $$$$$    \  $$$$/       | $$$$$     | $$  | $$ $$ $$| $$  | $$| $$$$$   | $$$$$$$/
{color.red} | $$__  $$| $$__/     >$$  $$       | $$__/     | $$  | $$  $$$$| $$  | $$| $$__/   | $$__  $$
{color.red} | $$  | $$| $$       /$$/\  $$      | $$        | $$  | $$\  $$$| $$  | $$| $$      | $$  \ $$
{color.red} | $$  | $$| $$$$$$$$| $$  \ $$      | $$       /$$$$$$| $$ \  $$| $$$$$$$/| $$$$$$$$| $$  | $$
{color.red} |__/  |__/|________/|__/  |__/      |__/      |______/|__/  \__/|_______/ |________/|__/  |__/
                                                                                                                             
{color.blue}                                                                                                     Updated by: Hexlorsn
...
if len(target_url) < 5:
    print('['+Fore.RED+'!'+Fore.WHITE+']'+Fore.YELLOW+' Very short target! check and try again')
    time.sleep(3.0)
    sys.exit()
else:
    pass
